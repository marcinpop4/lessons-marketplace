...
export class LessonRequestController {
     ...
     */
    transformToModel(prismaRequest) {
        const address = new Address(prismaRequest.address.street, prismaRequest.address.city, prismaRequest.address.state, prismaRequest.address.postalCode, prismaRequest.address.country);
        return new LessonRequest(prismaRequest.id, prismaRequest.type, new Date(prismaRequest.startTime), prismaRequest.durationMinutes, address, prismaRequest.student);
    }
    /**
    ...
    async createLessonRequest(req, res) {
        try {
            ...
            const quotes = await teacherQuoteService.createQuotesForLessonRequest(lessonRequest.id, type);
     ...
     * @param res - Express response
     */
    async getLessonRequestsByStudent(req, res) {
        try {
