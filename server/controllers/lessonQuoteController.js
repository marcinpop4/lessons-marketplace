...
export const lessonQuoteController = {
     ...
     */
    createLessonQuotes: async (req, res, next) => {
        try {
     ...
     * @param next NextFunction
     */
    getLessonQuoteById: async (req, res, next) => {
        try {
            const { id } = req.params;
     ...
     * @param next NextFunction
     */
    getLessonQuotesByRequestId: async (req, res, next) => {
        try {
     ...
     * @param next NextFunction
     */
    acceptLessonQuote: async (req, res, next) => {
        try {
