...
class PasswordAuthProvider {
    async authenticate(credentials) {
        ...
        const refreshToken = await authService.generateRefreshToken(user.id, userType === 'STUDENT' ? 'STUDENT' : 'TEACHER');
        return {
            user: {
                id: user.id,
                email: user.email,
    ...
    async register(userData) {
        const { email, password, firstName, lastName, phoneNumber, dateOfBirth, userType } = userData;
        // Hash the password
